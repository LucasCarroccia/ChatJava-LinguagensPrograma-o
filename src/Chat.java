...
public class Chat extends JFrame {
    ...
    public Chat() {
        ...
        painelMensagens.setBackground(
                new Color(115,108,108)
        );

        JScrollPane scroll =
                new JScrollPane(painelMensagens);
